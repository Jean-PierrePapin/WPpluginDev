...
function vsel_field_callback_49() {
	...
	<p><i><?php esc_attr_e( 'This also disables the ability to set a custom order for events with the same date.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_15() {
	...
	<p><i><?php esc_attr_e( 'This has no effect on the date icons.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
