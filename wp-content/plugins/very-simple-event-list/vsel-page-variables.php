...
$start_default = sprintf(esc_attr($page_start_label), '<span>'.wp_date( esc_attr($date_format), esc_attr($page_start_date), $utc_time_zone ).'</span>' );
$end_default = sprintf(esc_attr($page_end_label), '<span>'.wp_date( esc_attr($date_format), esc_attr($page_end_date), $utc_time_zone ).'</span>' );
$same_default = sprintf(esc_attr($page_date_label), '<span>'.wp_date( esc_attr($date_format), esc_attr($page_end_date), $utc_time_zone ).'</span>' );
$start_icon_1 = '<span class="vsel-day vsel-day-top">'.wp_date( 'j', esc_attr($page_start_date), $utc_time_zone ).'</span><span class="vsel-month">'.wp_date( 'M', esc_attr($page_start_date), $utc_time_zone ).'</span><span class="vsel-year">'.wp_date( 'Y', esc_attr($page_start_date), $utc_time_zone ).'</span>';
$start_icon_2 = '<span class="vsel-month vsel-month-top">'.wp_date( 'M', esc_attr($page_start_date), $utc_time_zone ).'</span><span class="vsel-day">'.wp_date( 'j', esc_attr($page_start_date), $utc_time_zone ).'</span><span class="vsel-year">'.wp_date( 'Y', esc_attr($page_start_date), $utc_time_zone ).'</span>';
$end_icon_1 = '<span class="vsel-day vsel-day-top">'.wp_date( 'j', esc_attr($page_end_date), $utc_time_zone ).'</span><span class="vsel-month">'.wp_date( 'M', esc_attr($page_end_date), $utc_time_zone ).'</span><span class="vsel-year">'.wp_date( 'Y', esc_attr($page_end_date), $utc_time_zone ).'</span>';
$end_icon_2 = '<span class="vsel-month vsel-month-top">'.wp_date( 'M', esc_attr($page_end_date), $utc_time_zone ).'</span><span class="vsel-day">'.wp_date( 'j', esc_attr($page_end_date), $utc_time_zone ).'</span><span class="vsel-year">'.wp_date( 'Y', esc_attr($page_end_date), $utc_time_zone ).'</span>';
